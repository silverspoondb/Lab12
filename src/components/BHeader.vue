<template>
  ...
  <div class="container">
    <header class="d-flex justify-content-between align-items-center py-3">
      ...
      <div>
        <button v-if="isAuthenticated" class="btn btn-outline-secondary btn-sm" @click="logout">Logout</button>
        <router-link v-else to="/signin" class="btn btn-outline-primary btn-sm">Sign In</router-link>
      </div>
    </header>
  </div>
</template>
